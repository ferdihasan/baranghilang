<nav class="navbar navbar-expand-lg  bg-primary shadow mb-3" data-bs-theme="dark">
    <div class="container">
        <a class="navbar-brand" href="/">Barang Hilang</a>
        ...
        <ul class="navbar-nav ">
            ...
            @auth
                <li class="nav-item">
                    <a class="nav-link {{ ($title === "Posting Barang") ? 'active' : '' }}" href="/posting-barang">Posting Barang</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ ($title === "Administrator") ? 'active' : '' }}" href="/administrator">Administrator</a>
                </li>             
            @else
                {{-- <li class="nav-item">
